 ...
 * Guarantees incremental, reliable persistence to Cloudflare D1.
 */
  ...
  try {
    ...
    await env.DB.prepare(`
      INSERT INTO meme_curation (
        meme_id, corpus_status, duplicate_of, topics, tone,
        humour_mechanisms, curator_note, reviewed_at, updated_at
      )
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
